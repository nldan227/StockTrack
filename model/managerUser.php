...
<head>
    ...
    <script>
        ...
        const inputs = document.querySelectorAll("form[name='frm-addUsers'] input, form[name='frm-addUsers'] select");
        cancelButton.addEventListener("click", function () {
            inputs.forEach((input) => {
                if (input.type === "text" || input.type === "password" || input.tagName === "SELECT") {
                    input.value = ""; // Đặt giá trị rỗng cho input và select
                }
            });
       ...
       // Kiểm tra Password
        ...
        emailInput.addEventListener("blur", function () {
            ...
            if (email === "") {
                errorSpan.textContent = "Email không được để trống.";
            }else{
